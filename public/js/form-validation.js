...
var loginSchema = yup__WEBPACK_IMPORTED_MODULE_0__.object().shape({
  username: yup__WEBPACK_IMPORTED_MODULE_0__.string().required(),
  password: yup__WEBPACK_IMPORTED_MODULE_0__.string().required()
});
var previousErrors = null;
var loginForm = document.querySelector("#login-form");

if (loginForm) {
  loginForm.addEventListener("submit", function (e) {
    var username = loginForm.querySelector("#username-input");
    var password = loginForm.querySelector("#password-input");
...
function showErrors(errors) {
  var objectsAreEqual = JSON.stringify(previousErrors) === JSON.stringify(errors);
  ...
  ol.classList.add("error-wrapper-list"); // loop through errors and create li elements and attach them to ol element
